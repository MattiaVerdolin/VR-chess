 ...
 * Constructor.
 */
ENG_API Shader::Shader() : type(TYPE_UNDEFINED),
glId(0)
{}
 ...
 */
ENG_API int Shader::getParamLocation(const char* name)
{
	// Safety net:
	if (name == nullptr)
	{
 ...
 */
ENG_API bool Shader::loadFromMemory(int type, const char* data)
{
	// Safety net:
	if (data == nullptr)
	{
 ...
 * @return true/false on success/failure
 */
ENG_API bool Shader::loadFromFile(int type, const char* filename)
{
	// Safety net:
	if (filename == nullptr)
	{
 ...
 * @return true/false on success/failure
 */
ENG_API bool Shader::build(Shader* vertexShader, Shader* fragmentShader)
{
	// Safety net:
 ...
 */
ENG_API bool Shader::render(void* data)
{
	// Activate shader:
	if (glId)
		glUseProgram(glId);
...
ENG_API void Shader::setInt(int param, int value)
{
	glUniform1i(param, value);
}

ENG_API void Shader::setVec3(int param, const glm::vec3& vect)
{
	glUniform3fv(param, 1, glm::value_ptr(vect));
}

ENG_API void Shader::setVec4(int param, const glm::vec4& vect)
{
	glUniform4fv(param, 1, glm::value_ptr(vect));
}

ENG_API void Shader::bind(int location, const char* attribName)
{
