 ...
 * Constructor.
 */
ENG_API Leap::Leap() : connection{ nullptr }, curFrame{ nullptr },
lastFrameId{ 0 }
{}
 ...
 */
ENG_API const LEAP_TRACKING_EVENT* Leap::getCurFrame() const
{
    return &curFrame;
}